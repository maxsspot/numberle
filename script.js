...
const number = Math.floor(Math.random()*35) + 1;
            ...
            function sharern() {
             if (navigator.share) { 
                         navigator.share({ text:'Hey there, I found this game called Numerale and though you would enjoy it! https://play.google.com/store/apps/details?id=app.netlify.numerale.twa&gl=US is for Android and https://www.microsoft.com/en-us/p/numerale/9n1q25gx2nn3?activetab=pivot:overviewtab is for PC!'}) 
