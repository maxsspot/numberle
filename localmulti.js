...
var localMultiplayer = document.createElement ("option");timedChallengeMode.value = "Local Multiplayer";timedChallengeMode.text = "Local Multiplayer";mode.appendChild(localMultiplayer);
